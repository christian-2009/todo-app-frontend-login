...
export default function MainContent(): JSX.Element {
    ...
    const [displayToDoList, setDisplayToDoList] =useState<any[]>([])
    const [toggle, setToggle] = useState<boolean>(true)

    function handleFormChange(event : (React.ChangeEvent<HTMLTextAreaElement> | React.ChangeEvent<HTMLInputElement>)) {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const response = await axios.post(backendURL + 'todo', todoForm)
    ...
    console.log('outside function', displayToDoList)
